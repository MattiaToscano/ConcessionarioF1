...
# Installa e configura Sanctum
php artisan install:api
php artisan vendor:publish --provider="Laravel\Sanctum\SanctumServiceProvider"

# Configura il database nel file .env
# Esegui le migrazioni (include tabelle Sanctum)
php artisan migrate
...
```bash
# Crea e naviga nella cartella frontend
mkdir frontend && cd frontend

# Inizializza progetto React con Vite
